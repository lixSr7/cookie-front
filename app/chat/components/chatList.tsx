...
export default function ChatList({ onSelectChat, searchTerm }: ChatListProps) {
  ...
  return (
    <div className="w-full min-w-[250px] mt-3 text-white h-full md:h-screen overflow-hidden">
      <ScrollShadow
              hideScrollBar
  ...
  return (
    <div className="space-y-2">
      {[1, 2, 3, 4, 5, 6].map((index) => (
        <Skeleton key={index} className="h-[80px] w-[240px] rounded-lg" />
      ))}
    </div>
  );
};
