...
const OtherProfileUser: React.FC<OtherProfileUserProps> = ({ userId, onClose }) => {
 ...
 return (
  <div >
   <Modal isOpen={isOpen} scrollBehavior="inside" onClose={onClose} size="5xl" backdrop="blur" placement="center">
    <ModalContent>
     <>
           ...
           <div className="flex flex-col items-center w-full h-full">
            <div className="flex flex-col items-center w-full h-max">
             ...
             <div className="flex flex-col items-center w-full h-max gap-4">
              <ButtonGroup size="sm">
               <Button className="transition-transform transform hover:scale-105 hover:shadow-lg">Following <span>{user.following.length}</span></Button>
               <Button className="transition-transform transform hover:scale-105 hover:shadow-lg">Followers <span>{user.followers.length}</span></Button>
              ...
              <ButtonGroup>
               <Button color="danger" variant="light" className="transition-transform transform hover:scale-105 hover:shadow-lg">Follow</Button>
               <Button color="secondary" variant="light" className="transition-transform transform hover:scale-105 hover:shadow-lg">Add Friend</Button>
              </ButtonGroup>
             </div>
